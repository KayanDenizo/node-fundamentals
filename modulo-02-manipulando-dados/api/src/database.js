...
export class DataBase {
    #database = {} //# significa que é privado, so esta disponivel dentro da classe
    ...
    select(table) {
        return this.#database[table] ?? [] // Se tiver conteudo retorna o conteudo, caso contrario (??) retorna uma lista (array) vazia
    }
}
