...
## 📝 Descrição
Este repositório reúne minha evolução no módulo de fundamentos do Node.js da Rocketseat. Aqui eu construo uma API do zero — sem frameworks — para aprender literalmente o coração do Node: como ele funciona, como tratar requisições, como criar middlewares, como organizar rotas e como construir um servidor na mão.
